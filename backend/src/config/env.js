...
const env = cleanEnv(process.env, {
  ...
  MIERU_AUTO_SYNC: bool({ default: false }),
  ...
  MIERU_SYNC_MAX_USERS: num({ default: 50000 }),
  MIERU_SYNC_DEBOUNCE_MS: num({ default: 1500 }),
  MIERU_SYNC_INCLUDE_NON_ACTIVE_USERS: bool({ default: false }),
