...
const env = cleanEnv(process.env, {
  ...
  RATE_LIMIT_MAX_REQUESTS: num({ default: toNumber(process.env.RATE_LIMIT_MAX, 10000) }),
  AUTH_RATE_LIMIT_MAX: num({ default: 1000 }),
  AUTH_REFRESH_RATE_LIMIT_MAX: num({ default: 120 }),
  AUTH_PROFILE_RATE_LIMIT_MAX: num({ default: 30 }),
